...
export { opacity, blurs, backdropBlurs, shadows } from './effects'
export { durations, easings, transitions } from './animations'
...
import { opacity, blurs, backdropBlurs, shadows } from './effects'
